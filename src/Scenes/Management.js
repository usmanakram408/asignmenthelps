    ...
    return (
        <>
            ...
            <div className="container">
                <div className='row '>
                    <div className="col">
                        <p class="h5 mx-5">We offer management assignment help in following areas:</p>
                        <p class=" mx-5"> <li className='text-primary'>Fundamentals of Computer Science</li>
                            <li className='text-primary' >Marketing Management</li>
                            <li className='text-primary' >Organizational Behaviour</li>
                            <li className='text-primary' >Business Environment</li>
                            <li className='text-primary' >Human Resource Management</li>
                            <li className='text-primary' >Business Research</li>
                            <li className='text-primary' >E-Business</li>
                            <li className='text-primary' >International Business</li>
                            <li className='text-primary' >Information Systems Management</li>
                        </p>
                    </div>
                </div >
            </div>
