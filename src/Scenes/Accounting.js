                ...
                <div className='row '>
                    <div className="col">
                        ...
                        <p class="container "> <li className='text-primary'>Management Accounting</li>
                            ...
                            <li className='text-primary' >Financial Statement</li>
                            <li className='text-primary' >Job Costing</li>
                            <li className='text-primary' >Tracking Job Cost</li>
                            <li className='text-primary' >Accounting for Actual and Applied Overhead</li>
                            <li className='text-primary' >Process Costing</li>
                            <li className='text-primary' >Activity-Based Costing</li>
                            <li className='text-primary' >Cost Allocation to Completed Units</li>
                            <li className='text-primary' >Cost Behavior Analysis</li>
                            <li className='text-primary' >Economies of Scale</li>
                        </p>
                    </div>
                </div >
            </div>
